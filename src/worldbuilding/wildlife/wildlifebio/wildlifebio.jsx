...
export function WildlifeBio() {
    ...
    <main className="bio worldbuilding">
        <Table className="infocard adaptive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Monster/Animal</td>
                </tr>
                <tr>
                    <th>Biomes</th>
                    <td>List of biomes it likes</td>
                </tr>
        ...
        <div id="shortDescription">
            <h2> Description</h2>
            <p>
                Short summary of the Wildlife here, with their, appearance etc.
            </p>
        </div>
