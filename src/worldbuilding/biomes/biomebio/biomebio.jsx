...
export function BiomeBio() {
    ...
    <main className="bio worldbuilding">
        ...
        <div id="shortDescription">
            <h2> Description</h2>
            <p>
                Short summary of the Biome here, appearance etc.
            </p>
        </div>

        <div id="longDescription">
            <h2 className="theme-h adaptive">Description</h2>
            <p>
