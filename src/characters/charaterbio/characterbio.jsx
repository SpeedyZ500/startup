    ...
    <main className="bio">
        <Table className="infocard adaptive">
            ...
            <tbody>
                    ...
                    <td colSpan={2} style={{padding: 0, margin: 0}}>
                        <Table width="100%">
                            ...
                            <tbody>
                                <tr>
                                    <th>Relation Type</th>
                                    <td>List of relatives of this type</td>
                                </tr>
                            </tbody>
                ...
                <tr>
                    <th>World</th>
                    <td>Homeworld here with link</td>
                </tr>
                <tr>
                    <th>Groups</th>
                    <td>List of Organizations affiliated with with links to them</td>
                </tr>
                <tr>
                    <td colSpan={2}>
        ...
        <div id="shortDescription">
            <h2> Description</h2>
            <p>
                Short summary of the character here, with their past, appearance etc.
            </p>
        </div>
        <Accordion className="internal-nav">
            <p>
                Dynamic navigation thing here, won't create it because I would be forced to remake it next time anyways
            </p>
        </Accordion>
